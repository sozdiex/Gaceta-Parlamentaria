...
- (void)setSelected:(BOOL)selected animated:(BOOL)animated
{
    ...
    if(selected){
        ...
        if(!self.isOtherMonth){
            ...
            dotView.color = [[self.calendarManager.calendarAppearance dayDotColor] colorWithAlphaComponent:0.5f];
        }
...
- (void)reloadData
{
    ...
    [self.calendarManager.calendarAppearance setDayDotColor:[self.calendarManager.dataSource calendarEventColor:self.calendarManager date:self.date]];
